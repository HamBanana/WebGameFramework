...
4. **Modular code.** Acca splits the game into small focused modules so each subsystem is independently testable and replaceable. New systems plug in via the EventBus rather than reaching into each other.
...
The features below are implemented in the v0.1 codebase.
